...
=======
const resolveConfig = async function(configFile, { resolvedConfig, ...opts } = {}) {
  ...
  const { cwd, context, repositoryRoot, branch } = await normalizeOpts(opts)
>>>>>>> Add --resolvedConfig CLI flag
